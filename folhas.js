...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cpbarra"></div><div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/ri_gato.png?v=' + V + '" alt="">' + '<span class="rt">GATO</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/ri_pato.png?v=' + V + '" alt="">' + '<span class="rt">PATO</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/ri_bola.png?v=' + V + '" alt="">' + '<span class="rt">BOLA</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/ri_cebola.png?v=' + V + '" alt="">' + '<span class="rt">CEBOLA</span>' + '</div>' + '</div>' + '' +
  ...
  for(var i = 0; i < L.length; i++){
    ...
    (function(it2, id2, box2){
      ...
      q.onclick = function(){
        ...
        _dicaTec("Escreva a palavra que rima");
      };
      q.onkeydown = function(ev){ if(ev.key === "Enter" || ev.key === " "){ ev.preventDefault(); q.onclick(); } };
      var lin = el("div", "");   /* classe sem regra de CSS nenhuma (portao 4): o <div> fica, o nome morto sai */  lin.appendChild(q); box2.appendChild(lin);
    })(it, id, box);
    fechaItem(d, box, id, 0);
  }
}
